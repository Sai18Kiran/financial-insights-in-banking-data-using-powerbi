...
This project is currently maintained by Sai Kiran Reddy Kondreddygari, a Data Engineer with 3+ years of professional experience. Sai Kiran specializes in building scalable data pipelines, optimizing data infrastructure, and enabling real-time analytics. With expertise in Python, SQL, and Spark, Sai Kiran is committed to delivering reliable, efficient data solutions that support strategic decision-making.

## Contact

For any inquiries or support regarding this project, please feel free to reach out to Sai Kiran Reddy Kondreddygari:
